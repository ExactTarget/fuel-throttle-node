// Stub dependencies to allow Handlebars to load
// without error after RequireJS optimization
define('fs', {});
define('file', {});
define('path', {});
define('system', {});
...
define('handlebars', () => {
  ...
  exports.parse = function(...args) { return handlebars.parse(...args); }
  ...
  Handlebars.print = ast => new Handlebars.PrintVisitor().accept(ast);
  ...
  Handlebars.log = (level, str) => { Handlebars.logger.log(level, str); };
  ...
  (((Compiler, JavaScriptCompiler) => {
    ...
    Compiler.multiParamSize = code => Compiler.MULTI_PARAM_OPCODES[Compiler.DISASSEMBLE_MAP[code]];
    ...
    Compiler.prototype = {
      ...
      program(program) {
        ...
        this.depths.list = this.depths.list.sort((a, b) => a - b);
